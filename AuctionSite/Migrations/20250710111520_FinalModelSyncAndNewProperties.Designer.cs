...
namespace AuctionSite.Migrations
{
    ...
    [Migration("20250710111520_FinalModelSyncAndNewProperties")]
    partial class FinalModelSyncAndNewProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuctionSite.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AuctionSite.Models.AuctionItem", b =>
                {
                    b.HasOne("AuctionSite.Models.ApplicationUser", "CurrentBidder")
                        .WithMany()
                        .HasForeignKey("CurrentBidderId");

                    b.HasOne("AuctionSite.Models.ApplicationUser", "Seller")
                        .WithMany()
                        .HasForeignKey("SellerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("AuctionSite.Models.ApplicationUser", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("AuctionSite.Models.Bid", b =>
                {
                    ...
                    b.HasOne("AuctionSite.Models.ApplicationUser", "Bidder")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AuctionSite.Models.ApplicationUser", null)
                        .WithMany()
